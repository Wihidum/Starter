...
import event_divider.Divider;
import event_divider.EventDivider;
...
public class EventReceiver {
  private static Logger log = Logger.getLogger(EventReceiver.class);
    ...
    private static final EventReceiver testServer = new EventReceiver();
    ...
    private void start(int receiverPort) throws DataBridgeException {
        ...
        final Divider divider = new EventDivider();
      //  Thread t = new Thread((EventDivider)divider);
         //   t.start();
